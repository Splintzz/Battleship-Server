...
{ 
	...
	static final int MSG_BOARD_INFO = 6;
	
	private int msgType=-1;
	private String msg = null;
	private boolean isYourTurn;
	private boolean gameIsStillActive;
	...
	public boolean gameIsStillActive() {
		return  gameIsStillActive;
	}

	public void setGameIsStillActive(boolean gameIsStillActive) {
		this.gameIsStillActive = gameIsStillActive;
	}
